...
class VerificacionBarrasController extends Controller
{
    ...
    public function liquidacionVerificacionNumero($contrato,$numero){
        ...
        FROM verificaciones_has_liquidacion_bc vt, verificaciones_bc v
        where vt.contrato = '$contrato'
        and vt.estado = '1'
        and v.num_verificacion = vt.num_verificacion
        ...
        if(count($buscarContrato) <= 0){
            ...
            if(count($data) >0){
                ...
                * FROM verificaciones_bc 
                ...
                return ["status"=>"0", "message" => "No existe valores para guardar la verificación"];
            }      
        }
    }
