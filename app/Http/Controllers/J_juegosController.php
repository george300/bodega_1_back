...
class J_juegosController extends Controller
{
    ...
    {   
        ...
        if( empty($cursos) ){
            ...
            return "Este juego ya se encuentra asignado a este curso";
        }
    ...
    {   
        $juego= DB::SELECT("SELECT DISTINCT j .*, a.nombreasignatura, a.idasignatura, u.id_group FROM j_juegos j, j_temas_por_juego jt, temas t, asignatura a, usuario u WHERE j.id_tipo_juego = $tipo AND j.estado = 1 AND j.id_juego = jt.id_juego AND jt.id_tema = t.id AND t.id_asignatura = a.idasignatura AND j.id_docente = u.idusuario ORDER BY u.id_group");
