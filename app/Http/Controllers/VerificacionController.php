...
class VerificacionController extends Controller
{
    ...
    public function liquidacionVerificacionNumero($contrato,$numero){
        $traerInformacion = DB::select("SELECT 
        verificaciones_has_temporadas.verificacion_id as numero_verificacion,verificaciones_has_temporadas.contrato,verificaciones_has_temporadas.codigo,verificaciones_has_temporadas.cantidad,
        verificaciones_has_temporadas.nombre_libro,verificaciones_has_temporadas.desface, v.fecha_inicio, v.fecha_fin, verificaciones_has_temporadas.contrato 
        FROM verificaciones_has_temporadas, verificaciones v
        where verificaciones_has_temporadas.contrato = '$contrato'
        and verificaciones_has_temporadas.estado = '1'
        and v.num_verificacion = verificaciones_has_temporadas.verificacion_id
        and verificaciones_has_temporadas.verificacion_id = '$numero'
        ORDER BY verificaciones_has_temporadas.verificacion_id desc
