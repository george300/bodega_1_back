...
class PlanificacionController extends Controller
{
    ...
    {
        $planificaciones = DB::SELECT("SELECT p .*, l.nombrelibro, l.idlibro FROM planificacion p, libro l WHERE p.asignatura_idasignatura = l.asignatura_idasignatura AND l.Estado_idEstado = 1 AND l.idlibro = $id ORDER BY p.idplanificacion");
