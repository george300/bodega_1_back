...
class TicketController extends Controller
{
    ...
    {   
        ...
        $datosEstudiante = DB::SELECT("SELECT CONCAT(e.nombres,' ', e.apellidos) as usuario ,e.name_usuario,e.cedula,e.idusuario, i.nombreInstitucion,i.idInstitucion
        ...
        if($request->tabierto){
            ...
            $ticketAbierto = DB::SELECT("SELECT t.*, CONCAT(u.nombres,' ', u.apellidos) as usuario , (SELECT TIME(fecha) 
            FROM ticket_respuesta  WHERE ticket_id = t.ticket_id AND group_id <> '1' ORDER BY ticket_res_id DESC  LIMIT 1)  AS ultima_hora ,  (SELECT COUNT(ticket_id) as c FROM ticket_respuesta WHERE ticket_id = t.ticket_id AND group_id <> '1') as cantidad ,u.email,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
            FROM tickets t
        ...
        if($request->busqueda == 'fecha'){
            ...
            $ticketCerrado = DB::SELECT("SELECT t.*, CONCAT(u.nombres,' ', u.apellidos) as usuario , (SELECT TIME(fecha) 
            FROM ticket_respuesta  WHERE ticket_id = t.ticket_id AND group_id <> '1' ORDER BY ticket_res_id DESC  LIMIT 1)  AS ultima_hora ,  (SELECT COUNT(ticket_id) as c FROM ticket_respuesta WHERE ticket_id = t.ticket_id AND group_id <> '1') as cantidad ,u.email,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
            FROM tickets t
            LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
            LEFT JOIN usuario u ON t.usuario_id = u.idusuario
        ...
        if($request->busqueda == 'numero'){
                ...
                $ticketCerrado = DB::SELECT("SELECT t.*, CONCAT(u.nombres,' ', u.apellidos) as usuario,u.email ,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
                FROM tickets t
                LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
                LEFT JOIN usuario u ON t.usuario_id = u.idusuario
                LEFT JOIN sys_group_users g ON t.group_id = g.id
        ...
        if($request->busqueda == 'institucion'){
            ...
            $ticketCerrado = DB::SELECT("SELECT t.*, DATEDIFF(t.fecha_ticket_final,t.fecha_ticket) as dias ,CONCAT(u.nombres,' ', u.apellidos) as usuario,u.email ,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
            FROM tickets t
            LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
            LEFT JOIN usuario u ON t.usuario_id = u.idusuario
            LEFT JOIN sys_group_users g ON t.group_id = g.id
            ...
            $filtroInstituciones = DB::SELECT("SELECT DISTINCT i.idInstitucion, i.nombreInstitucion
            FROM tickets t
            LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
            LEFT JOIN usuario u ON t.usuario_id = u.idusuario
            LEFT JOIN sys_group_users g ON t.group_id = g.id
        ...
        if($request->reporteGeneral){
            $ticketCerrado = DB::SELECT("SELECT t.*,DATEDIFF(t.fecha_ticket_final,t.fecha_ticket) as dias, (SELECT COUNT(ticket_id) FROM ticket_respuesta WHERE ticket_id = t.ticket_id) as cantidad ,CONCAT(u.nombres,' ', u.apellidos) as usuario,u.email ,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
            FROM tickets t
            LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
            LEFT JOIN usuario u ON t.usuario_id = u.idusuario
            LEFT JOIN sys_group_users g ON t.group_id = g.id
        ...
        //=================CONTAR TICKETS==========================================
         ...
         if($request->cantAbiertos){
            $abiertos = DB::SELECT("SELECT COUNT(ticket_id) as cantidadA FROM tickets WHERE estado = '1'
         ...
         if($request->cantCerrados){
            $cerrados = DB::SELECT("SELECT COUNT(ticket_id) as cantidadC FROM tickets WHERE estado = '0'
        ...
        if($request->cantidadTicketNotificacion){
            ...
            $ticketAbierto = DB::SELECT("SELECT t.*, CONCAT(u.nombres,' ', u.apellidos) as usuario ,  (SELECT COUNT(ticket_id) FROM ticket_respuesta WHERE ticket_id = t.ticket_id AND group_id ='1') as cantidad ,u.email,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
            FROM tickets t
            LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
            LEFT JOIN usuario u ON t.usuario_id = u.idusuario
            LEFT JOIN sys_group_users g ON t.group_id = g.id

            WHERE t.usuario_id = $request->id  AND  t.estado = '1'
            ORDER BY t.ticket_id DESC");
    ...
    public function show($id)
    {
        ...
        $ticketAbierto = DB::SELECT("SELECT t.*, CONCAT(u.nombres,' ', u.apellidos) as usuario , (SELECT TIME(fecha) 
        FROM ticket_respuesta  WHERE ticket_id = t.ticket_id AND group_id = '1' ORDER BY ticket_res_id DESC  LIMIT 1)  AS ultima_hora,  (SELECT COUNT(ticket_id) FROM ticket_respuesta WHERE ticket_id = t.ticket_id AND group_id ='1') as cantidad ,u.email,u.name_usuario,u.cedula,u.idusuario, i.nombreInstitucion, g.deskripsi as rol
        FROM tickets t
        LEFT JOIN institucion i ON t.institucion_id = i.idInstitucion
        LEFT JOIN usuario u ON t.usuario_id = u.idusuario
        LEFT JOIN sys_group_users g ON t.group_id = g.id
