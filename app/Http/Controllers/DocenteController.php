...
class DocenteController extends Controller
{
    ...
    {
        $agenda = DB::SELECT("SELECT i.nombreInstitucion, a.id, a.id_usuario, a.nombre_institucion_temporal,a.estado_institucion_temporal,
         CONCAT(a.title, ' (', a.hora_inicio, ' - ', a.hora_fin, ')' ) as title, a.label, a.classes, a.startDate, a.endDate, a.hora_inicio, a.hora_fin, a.url, a.opciones, a.institucion_id FROM agenda_usuario a 
